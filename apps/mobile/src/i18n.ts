...
const ru: Dict = {
  ...
  "freeze.caught": "😏 {name} попался!",
  "freeze.preparing": "Гифка готовится…",
  "freeze.continue": "Продолжить",
  "freeze.waitingOthers": "Жду остальных: {ready}/{total}",
  // настройки
...
const en: Dict = {
  ...
  "freeze.caught": "😏 {name} got caught!",
  "freeze.preparing": "Preparing the clip…",
  "freeze.continue": "Continue",
  "freeze.waitingOthers": "Waiting for others: {ready}/{total}",
